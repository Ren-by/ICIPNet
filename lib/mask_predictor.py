...
class SimpleDecoding(nn.Module):
    ...
    def __init__(self, c4_dims, factor=2):
        ...
        self.conv1_4 = nn.Conv2d(c4_size + c3_size,
                                 hidden_size,
                                 3,
                                 padding=1,
                                 bias=False)
        routing_function1 = RountingFunction(in_channels=hidden_size,
                                             kernel_number=1)
        self.conv2_4 = AdaptiveRotatedConv2d(in_channels=hidden_size,
                                             out_channels=hidden_size,
                                             kernel_size=3,
                                             padding=1,
                                             rounting_func=routing_function1,
                                             bias=False,
                                             kernel_number=1)

        # self.bn1_4 = nn.BatchNorm2d(hidden_size)
        self.bn1_4 = DyT(hidden_size)
        self.relu1_4 = nn.ReLU()
        # self.bn2_4 = nn.BatchNorm2d(hidden_size)
        self.bn2_4 = DyT(hidden_size)
        self.relu2_4 = nn.ReLU()

        self.conv1_3 = nn.Conv2d(hidden_size + c2_size,
                                 hidden_size,
                                 3,
                                 padding=1,
                                 bias=False)
        routing_function2 = RountingFunction(in_channels=hidden_size,
                                             kernel_number=1)
        self.conv2_3 = AdaptiveRotatedConv2d(in_channels=hidden_size,
                                             out_channels=hidden_size,
                                             kernel_size=3,
                                             padding=1,
                                             rounting_func=routing_function2,
                                             bias=False,
                                             kernel_number=1)
        # self.bn1_3 = nn.BatchNorm2d(hidden_size)
        self.bn1_3 = DyT(hidden_size)
        self.relu1_3 = nn.ReLU()
        # self.bn2_3 = nn.BatchNorm2d(hidden_size)
        self.bn2_3 = DyT(hidden_size)
        self.relu2_3 = nn.ReLU()

        self.conv1_2 = nn.Conv2d(hidden_size + c1_size,
                                 hidden_size,
                                 3,
                                 padding=1,
                                 bias=False)
        routing_function3 = RountingFunction(in_channels=hidden_size,
                                             kernel_number=1)
        self.conv2_2 = AdaptiveRotatedConv2d(in_channels=hidden_size,
                                             out_channels=hidden_size,
                                             kernel_size=3,
                                             padding=1,
                                             rounting_func=routing_function3,
                                             bias=False,
                                             kernel_number=1)
        # self.bn1_2 = nn.BatchNorm2d(hidden_size)
        self.bn1_2 = DyT(hidden_size)
        self.relu1_2 = nn.ReLU()
        # self.bn2_2 = nn.BatchNorm2d(hidden_size)
        self.bn2_2 = DyT(hidden_size)
